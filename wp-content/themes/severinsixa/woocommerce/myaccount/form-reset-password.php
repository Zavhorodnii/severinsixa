...
<!--                <p>--><?php //echo apply_filters('woocommerce_reset_password_message', esc_html__('Enter a new password below.', 'woocommerce')); ?><!--</p>--><?php //// @codingStandardsIgnoreLine ?>
                <div class="input-wrap">
                    <p class="input-title"><?php esc_html_e('New password', 'woocommerce'); ?><span>*</span></p>
                    <input type="password" class="woocommerce-Input woocommerce-Input--text input"
                           name="password_1" id="password_1" placeholder="<?php esc_html_e('New password', 'woocommerce'); ?>" autocomplete="new-password"/>
                </div>

                <div class="input-wrap">
                    <p class="input-title"><?php esc_html_e('Re-enter new password', 'woocommerce'); ?><span>*</span></p>
                    <input type="password" class="woocommerce-Input woocommerce-Input--text input"
                           name="password_2" id="password_2" placeholder="<?php esc_html_e('Re-enter new password', 'woocommerce'); ?>" autocomplete="new-password"/>
                </div>
