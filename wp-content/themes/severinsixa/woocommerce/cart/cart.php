...
//                            $product_permalink = apply_filters( 'woocommerce_cart_item_permalink', $_product->is_visible() ? $_product->get_permalink( $cart_item ) : '', $cart_item, $cart_item_key );
                                ...
                                <div class="cart__product-info">
                                    ...
                                    <div class="cart__product-center">
                                        ...
                                        <div class="select-block-wrap">
                                            <select class="amount-block js_change_quantity js_loader_control">
                                                <?php
                                                $index = 1;
                                                while ($index < 4){
                                                    ?>
                                    ...
                                    ?>
                                    <button class="cart__product-delete body-s js_remove_from_cart js_loader_control" type="button">
                                        Entfernen
                                    </button>
                                </div>
                            </div>
                ...
                <aside class="cart__aside js_loader_control">
