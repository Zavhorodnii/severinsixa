					...
					<table style="width: 100%;" id="my_table_for_front_woospca">
						<tr>
							<td style="width: 100%;vertical-align: top;">
								...
								<ul class="nav nav-tabs plugify_nav" role="tablist" style="margin-left: unset;">
									<center>
			...
			<table style="width: 100%;" id="my_table_for_front_woospca">
				...
				<tr>
					...
					<td style="width: 100%;vertical-align: top;">
						...
						<ul class="nav nav-tabs plugify_nav" role="tablist" style="margin-top: 15px !important;">
															...
															?>
																<script type="text/javascript">
																	if (true=='<?php echo filter_var($activegroponload); ?>') {
																		...
																		jQuery('.dropbtn'+thiss.parent().parent().parent().attr('special')).css('background','#<?php echo filter_var($woospca_a_bg_c); ?>');

																		jQuery('.dropbtn'+thiss.parent().parent().parent().attr('special')).css('color','#<?php echo filter_var($woospca_a_t_c); ?>');
																		jQuery('.dropbtn'+thiss.parent().parent().parent().attr('special')).css('border-top','3px solid #<?php echo filter_var($woospca_a_brdrandcorner_c); ?>');
																		jQuery('.dropbtn'+thiss.parent().parent().parent().attr('special')).css('border-bottom','3px solid #<?php echo filter_var($woospca_a_brdrandcorner_c); ?>');
																	...
																	jQuery('#my_table_for_front_woospca').find('li').on('click',function(){
																		if(!jQuery(this).attr('special')) {
																			...
																			jQuery('.dropbtn').css('background','#<?php echo filter_var($woospca_d_bg_c); ?>');

																			jQuery('.dropbtn').css('color','#<?php echo filter_var($woospca_d_t_c); ?>');
																			jQuery('.dropbtn').css('border-top','3px solid #<?php echo filter_var($woospca_d_brdrandcorner_c); ?>');
																			jQuery('.dropbtn').css('border-bottom','3px solid #<?php echo filter_var($woospca_d_brdrandcorner_c); ?>');
																	...
																	jQuery('#my_table_for_front_woospca').find('.dropdown-content').find('a').on('click',function(){
																		...
																		jQuery('.dropbtn').css('background','#<?php echo filter_var($woospca_d_bg_c); ?>');
																		jQuery('.dropbtn').css('color','#<?php echo filter_var($woospca_d_t_c); ?>');
																		jQuery('.dropbtn'+jQuery(this).parent().parent().parent().attr('special')).css('background','#<?php echo filter_var($woospca_a_bg_c); ?>');

																		jQuery('.dropbtn'+jQuery(this).parent().parent().parent().attr('special')).css('color','#<?php echo filter_var($woospca_a_t_c); ?>');
																		jQuery('.dropbtn'+jQuery(this).parent().parent().parent().attr('special')).css('border-top','3px solid #<?php echo filter_var($woospca_a_brdrandcorner_c); ?>');
																		jQuery('.dropbtn'+jQuery(this).parent().parent().parent().attr('special')).css('border-bottom','3px solid #<?php echo filter_var($woospca_a_brdrandcorner_c); ?>');
																...
																<style type="text/css">
																	...
																	.dropdown:hover .dropbtn {
																		background-color: #<?php echo filter_var($woospca_h_bg_c); ?>;
																	}
																	...
																	.tab .nav-tabs li a{
																		...
																		padding: 10px 20px;
																		/*margin-right: 15px;*/
																		background: #<?php echo filter_var($woospca_d_bg_c); ?>;
																		font-size: 17px;
																		font-weight: 600;
																		color: #<?php echo filter_var($woospca_d_t_c); ?>;
																		text-transform: uppercase;
																		border: none;
																		border-top: 3px solid #<?php echo filter_var($woospca_d_brdrandcorner_c); ?>;
																		border-bottom: 3px solid #<?php echo filter_var($woospca_d_brdrandcorner_c); ?>;
																		border-radius: 0;
																		overflow: hidden;
																		position: relative;
																		transition: all 0.3s ease 0s;
																	...
																	.tab .nav-tabs li.active a{
																		...
																		background: #<?php echo filter_var($woospca_a_bg_c); ?>;
																		color: #<?php echo filter_var($woospca_a_t_c); ?>;
																	}
																	.tab .nav-tabs li a:hover{
																		border: none;
																		border-top: 3px solid #<?php echo filter_var($woospca_h_brdrandcorner_c); ?>;
																		border-bottom: 3px solid #<?php echo filter_var($woospca_h_brdrandcorner_c); ?>;
																		background: #<?php echo filter_var($woospca_h_bg_c); ?>;
																		color: #<?php echo filter_var($woospca_h_t_c); ?>;
																	}
																	...
																	.tab .tab-content:before{
																		content: "";
																		border-top: 25px solid #<?php echo filter_var($woospca_a_brdrandcorner_c); ?>;
																	...
																	.tab .tab-content:after{
																		content: "";
																		border-bottom: 25px solid #<?php echo filter_var($woospca_a_brdrandcorner_c); ?>;
																	...
																	#my_table_for_front_woospca li{
																		padding: <?php echo filter_var($woospca_p_t . 'px ' . $woospca_p_r . 'px ' . $woospca_p_b . 'px ' . $woospca_p_l . 'px '); ?> !important;
																	}
