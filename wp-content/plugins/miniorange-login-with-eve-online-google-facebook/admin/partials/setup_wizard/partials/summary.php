...
function mo_oauth_client_summary(){
  ...
  echo '<label> Send client credentials in :</label>
      <div class="mo-summary-callback mo-summary-data mo-summary-flex-shrink" ><input type="checkbox" name="mo_oauth_authorization_header" id="send_header" checked>Header</div><div class="mo-summary-callback mo-summary-data mo-summary-flex-grow"><input type="checkbox" name="mo_oauth_body" id="send_body" >Body</div>
