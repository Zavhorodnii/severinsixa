 ...
 */
function mo_oauth_client_setup_endpoints(){
	echo '	<!-- content main --> 
	        <h4>Provider Metadata<span class="mo-oauth-setup-guide"></span></h4>';
	echo '	        <div class="field-group">
			    <label>App name</label>
			    <input title="Display Name"
			    type="text" class="mo-normal-text" name="displayName" id="displayName" value="" placeholder="Company Name" onkeyup="mo_oauth_update_display_name_description()" >
