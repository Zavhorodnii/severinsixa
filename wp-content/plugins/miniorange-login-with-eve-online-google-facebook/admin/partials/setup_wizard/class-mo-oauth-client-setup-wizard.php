...
class Mo_OAuth_Client_Setup_Wizard{
	...
	public function page(){
		echo '<head>
			...
			wp_enqueue_script( 'mo_oauth_setup_wizard_troubleshooting_script', plugin_dir_url( __FILE__ ) . '/js/troubleshooting.js',array(),MO_OAUTH_SETUP_WIZARD_VERSION );
					...
					if("mo-btn-next" == target || "mo-btn-back" == target){
						jQuery.post(mo_oauth_ajax_object.ajax_url, data, function(response){
							...
							if("invalid" == discovery_validation){
								...
								mo_get_discovery_troubleshooting(response.mo_oauth_discovery_url,response.mo_oauth_input,response.mo_oauth_appId);
							}else{
