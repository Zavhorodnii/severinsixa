		...
		<form name="f" method="post" action="">
			...
			<div class="mo_table_layout">
				<div id="toggle1" class="">
					<h3><?php esc_html_e( 'Register with miniOrange', 'miniorange-login-with-eve-online-google-facebook' ); ?> <small style="font-size: x-small;">[OPTIONAL]</small></h3> 
				</div>
				<div id="panel1">
					...
					<table class="mo_settings_table">
						...
						<tr>
							...
							<td><br><input type="submit" name="submit" value="<?php esc_attr_e( 'Register', 'miniorange-login-with-eve-online-google-facebook' ); ?>" class="button button-primary button-large"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" name="mo_oauth_client_goto_login" id="mo_oauth_client_goto_login" value="<?php esc_attr_e( 'Already have an account?', 'miniorange-login-with-eve-online-google-facebook' ); ?>" class="button button-primary button-large"/>&nbsp;&nbsp;</td>
						</tr>
					</table>
				</div>
			</div>
...
function mo_oauth_client_show_customer_info() {
	...
	<a href="<?php echo esc_attr( add_query_arg( array( 'tab' => 'licensing' ), htmlentities( esc_attr( sanitize_text_field( wp_unslash( $_SERVER['SERVER_NAME'] ) ) ) ) ) ); ?>"><input type="button" class="button button-primary button-large" value="Check Licensing Plans"/></a>
	</td>
	</tr>
	</table>
