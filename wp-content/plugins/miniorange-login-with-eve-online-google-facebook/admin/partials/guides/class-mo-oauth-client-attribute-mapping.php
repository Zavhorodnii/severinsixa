...
class Mo_OAuth_Client_Admin_Attribute_Mapping {
    ...
    private static function emit_css() {
        ?>
        <style>.mo-side-table{border-collapse:collapse;}.mo-side-table-th {background-color: #eee; text-align: center; padding: 8px; border-width:1px; border-style:solid; border-color:#212121;}.mo-side-table-tr:nth-child(odd) {background-color: #f2f2f2;} .mo-side-table-td{padding:8px;border-width:1px; border-style:solid; border-color:#212121;word-break: break-all;}.attr-list-div{padding: 10px 0px;}</style>
        <?php
    }
