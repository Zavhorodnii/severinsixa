		...
		<table class="mo_settings_table">
            ...
            <?php } elseif(isset($currentapp['realm'])) { ?>
                    <tr>
                        ...
                        <td><input <?php if($valid_discovery == 'invalid') echo 'style="border-color:red;"'?> class="mo_table_textbox" type="text" name="mo_oauth_provider_realm" value="<?php echo esc_attr($currentapp['realm']); ?>">&nbsp;&nbsp;&nbsp;<?php if($valid_discovery == 'valid'){echo $is_valid; } else echo $is_invalid; ?></td>
                    </tr>
                    <?php
                }
            }
