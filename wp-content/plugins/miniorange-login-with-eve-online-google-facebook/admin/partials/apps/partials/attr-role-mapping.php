		...
		<tr>
			...
			<td>
				<select disabled  class="mo_table_textbox" style="background-color: #eee;">
					<option>'.esc_html__('Username','miniorange-login-with-eve-online-google-facebook').'</option>
				</select>
			</td></tr>
			<tr><td>&nbsp;</td></tr>
			...
			<tr>
				<td colspan="2">
					<strong>
						<input disabled type="checkbox">'.esc_html__(' Keep Existing User Attributes','miniorange-login-with-eve-online-google-facebook').'
					</strong><small> <a href="admin.php?page=mo_oauth_settings&tab=licensing" target="_blank" rel="noopener noreferrer">[PREMIUM]</a></small>
				</td>
			</tr>
			<tr>
				<td colspan="2"><p style="color:grey;margin-left:10px;font-size:14px"><small>'.esc_html__('If unchecked, each time existing WordPress User profile will get updated with above mapping. ','miniorange-login-with-eve-online-google-facebook').'<br/> <b>Note :</b>'.esc_html__(' User profile will get updated based on existing Usernames.','miniorange-login-with-eve-online-google-facebook').'</small></p>
				</td>
			</tr>
			<tr>
			  	<td colspan="2">
				    <table>
						<tr>
						  	<td>
						  		<strong><input disabled type="checkbox">'.esc_html__(' Keep Existing Email Attribute','miniorange-login-with-eve-online-google-facebook').'</strong><small> <a href="admin.php?page=mo_oauth_settings&tab=licensing" target="_blank" rel="noopener noreferrer">[PREMIUM]</a></small>
						  	</td>
						</tr>
						<tr><td colspan="2"><p style="color:grey;margin-left:10px;font-size:14px"><small>'.esc_html__('Uncheck only if you want existing user email to get updated each time after SSO.','miniorange-login-with-eve-online-google-facebook').' </small></p></td></tr>
				    </table>
				</td>
			</tr>
			<tr><td colspan="3"><hr></td></tr>
